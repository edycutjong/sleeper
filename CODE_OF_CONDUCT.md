...
Report unacceptable behaviour to the project maintainer via a
[private security advisory](https://github.com/edycutjong/sleeper/security/advisories/new) or by
opening an issue if the matter is not sensitive. All complaints will be reviewed and investigated
promptly and fairly.
